...
Define the GitHub Actions quality gate that runs the workspace checks on pull requests and pushes to `main`, with dependency and build caching, scoped strictly to checks (no deployments).
