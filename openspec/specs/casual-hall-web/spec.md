# casual-hall-web Specification

## Purpose

Defines the web client's casual hall surface and waiting room — browsing and creating open casual tables, rendering live seat occupancy and seat actions in a per-table waiting room, and handing the caller off to the live play route once a full table spawns a room.
