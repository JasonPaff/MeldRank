# match-spawn-gateway Specification

## Purpose

Defines the match service's authenticated internal spawn endpoint — the service-to-service control route the API calls to create an authoritative Colyseus room on demand, mapping a frozen variant, seating assignment, and bot count to a room handle.
