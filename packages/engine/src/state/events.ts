 ...
 * design decision 2. It is the four locked player **intents** (`bid`, `pass`,
 * `declareTrump`, `playCard` — consumed type-only from `@meldrank/shared`) plus
 * the two system events that have no player intent: `deal`, carrying the shuffle
 * seed, and `timeout`, a clock expiry for the seat to act. Modelling the deal
...
/**
 * The exact set of the six documented event kinds, as runtime values (the
